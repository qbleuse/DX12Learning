...
{
	return { model.c[0].x, model.c[1].x, model.c[2].x };
}


inline constexpr Vec3 Transform::up() const noexcept
{
	return { model.c[0].y, model.c[1].y, model.c[2].y };
}


inline constexpr Vec3 Transform::backward() const noexcept
{
	return { model.c[0].z, model.c[1].z, model.c[2].z };
}
...
{
	return { model.c[0].w, model.c[1].w, model.c[2].w };
}
